...
export const sizes: Size[] = [
  { id: '1', name: 'Extra Small', code: 'XS', order: 1 },
  { id: '2', name: 'Small', code: 'S', order: 2 },
  { id: '3', name: 'Medium', code: 'M', order: 3 },
  { id: '4', name: 'Large', code: 'L', order: 4 },
  { id: '5', name: 'Extra Large', code: 'XL', order: 5 },
  { id: '6', name: 'Double Extra Large', code: 'XXL', order: 6 },
]

export const colors: Color[] = [
  { id: '1', name: 'Black', code: 'BLK', hex: '#000000' },
  { id: '2', name: 'White', code: 'WHT', hex: '#FFFFFF' },
  { id: '3', name: 'Navy', code: 'NVY', hex: '#1F2937' },
  { id: '4', name: 'Gray', code: 'GRY', hex: '#6B7280' },
  { id: '5', name: 'Beige', code: 'BEI', hex: '#D4B896' },
  { id: '6', name: 'Brown', code: 'BRN', hex: '#8B4513' },
]
...
export const products: Product[] = [
  {
    ...
    description: 'Soft and comfortable premium cotton t-shirt perfect for everyday wear. Made from 100% organic cotton with a classic fit.',
    price: 2980,
    originalPrice: 3980,
    currency: 'JPY',
  ...
  },
  {
    ...
    description: 'Modern slim fit jeans crafted from premium Japanese denim. Features a comfortable stretch blend for all-day wear.',
    price: 8900,
    originalPrice: 12900,
    currency: 'JPY',
    ...
    brand: 'Denim Co.',
    tags: ['denim', 'slim-fit', 'stretch', 'japanese'],
    featured: true,
  ...
  },
  {
    ...
    description: 'Water-resistant windbreaker perfect for unpredictable weather. Features zippered pockets and adjustable hood.',
    price: 12800,
    currency: 'JPY',
    ...
    brand: 'Weather Pro',
    tags: ['windbreaker', 'water-resistant', 'lightweight', 'outdoor'],
    featured: false,
